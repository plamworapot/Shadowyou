...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        if(installation != null){
            Log.i("", "Location Update"+getLatitude()+" "+getLongitude());
            ...
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject row, ParseException e) {
                    ParseGeoPoint point = new ParseGeoPoint(getLatitude(), getLongitude());
                    if(e == null && row != null){
                        row.put("location", point);
                        row.saveInBackground();
                        Log.i("", "Pares Update"+getLatitude()+" "+getLongitude());
                    }else if(row == null){
                        ParseObject object = new ParseObject("Device");
                        object.put("location", point);
                        object.put("installation", installation);
                        Log.i("", "Parse Create"+getLatitude()+" "+getLongitude());
